...
public class AgendaEventos {
	...
	// Metodo exibir agenda do eventos
	public void exibirAgenda() {
		...
		for (Map.Entry<LocalDate, Evento> entry : eventosTreeMap.entrySet()) {
			...
			System.out.println(
					"Data " + dataEvento + ", Evento: " + evento.getNome() + ", Atraçao: " + evento.getAtracao());
		}
	}

	// Método para obter os proximos eventos
	...
	public static void main(String[] args) {
		// Instanciando a classe AgendaEventos
